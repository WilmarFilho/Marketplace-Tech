    ...
    return (
        <header className={cn("w-full px-4 py-4", floating && "absolute inset-x-0 top-0 z-50")}> 
            <div className="mx-auto w-full max-w-[1744px]">
                <div className={cn("flex w-full items-center justify-between gap-[10px] px-6 py-3 md:px-[40px] md:py-[18px]", styles.pill)}>
                    {/* Logo */}
                    ...
                    <div className="flex items-center gap-[18px] md:gap-[31px]">
                        {user ? (
                            ...
                            <>
                                ...
                                <Link
                                    href="/auth/cadastro"
                                    className={cn("inline-flex items-center justify-center hover:brightness-95 transition", styles.ctaButton)}
                                >
                                    Cadastrar
                                </Link>
                            </>
