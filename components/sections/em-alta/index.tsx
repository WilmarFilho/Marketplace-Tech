...
import { FadeInScroll } from "@/components/animacoes/FadeInScroll"; // Importe aqui
...
export async function SecaoEmAlta() {
  ...
  return (
    <section className={cn("w-full scroll-mt-[262px]", styles.section)}>
      <FadeInScroll> 
        {/* O GSAP vai animar estes dois blocos div abaixo sequencialmente */}
